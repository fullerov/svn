...
<div class="container">
  <div class="header" align="center"><a href="index.php"><img class="headers" src="name.png" alt="SQL" name="logo" width="780" height="120" id="Insert_logo" style="background: #C0C0C0; display:block;" /></a>
...
//восстановление исходной таблицы
   ...
   {
	   $drop=mysql_query("DROP TABLE `u567383400_query.persons`",$db);
	   $drop_db=mysql_query("DROP DATABASE `u567383400_query`",$db);
	   $create_db=mysql_query("CREATE DATABASE `u567383400_query`",$db);
	   mysql_select_db("u567383400_query",$db);
	   $make=mysql_query("CREATE TABLE `u567383400_query`.`persons` (
