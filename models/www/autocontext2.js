...
Begun.DOM_TIMEOUT=1;
Begun.REVISION='$LastChangedRevision: 58450 $';
...
"begun_tpl_block_240x400":"57657",
"begun_tpl_block_240x400_custom":"58271",
"begun_tpl_block_468x60":"48310",
"begun_tpl_block_728x90":"56590",
"begun_tpl_block_728x90_custom":"58321",
"begun_tpl_block_flat":"47278",
"begun_tpl_block_horizontal":"55032",
"begun_tpl_block_square":"47859",
"begun_tpl_block_top":"48310",
"begun_tpl_block_vertical":"57717"
};
...
if(anyLink.href.indexOf('area=2')>0){
anyLink.href=anyLink.href.replace(/area=2/,'area=1');
}
...
anyLink.click();
if(anyLink.href.indexOf('area=1')>0){
anyLink.href=anyLink.href.replace(/area=1/,'area=2');
}
}else{
_this.Callbacks.dispatch('banner','click',curr_elem);
if(this.isEventTrackingOn()){
...
params.origin_pad_id=this.getPad().pad_id;
...
';
html['bnnr_card']='\
<span class="begun_adv_phone_wrapper"><a target="_blank" href="{{url}}&area=2" class="snap_noshots">{{phone}}</a><span class="begun_adv_card"><a target="_blank" href="{{url}}&area=2" class="snap_noshots">{{card_text}}</a></span></span>\
';
html['bnnr_card_no_phone']='\
<span class="begun_adv_phone_wrapper begun_adv_phone_no_icon"><span class="begun_adv_card"><a target="_blank" href="{{url}}&area=2" class="snap_noshots">{{card_text}}</a></span></span>\
';
html['bnnr_ppcall']='\
...
';
html['bnnr_domain']='\
<span class="begun_adv_contact"><a class="snap_noshots" target="_blank" href="{{url}}&area=2" onmouseover="status=\'{{status}}\';return true" onmouseout="status=\'\';return true" title="{{fullDomain}}">{{domain}}</a></span> \
';
html['bnnr_geo']='\
<span class="begun_adv_city"><a class="snap_noshots" target="_blank" href="{{url}}&area=2" onmouseover="status=\'{{status}}\';return true" onmouseout="status=\'\';return true" title="{{fullDomain}}">{{geo}}</a></span>\
';
html['bnnr_thumb']='\
<a href="{{url}}&area=2" class="begun_thumb snap_noshots" style="width:{{width}}px !important;height:{{height}}px !important;{{additionalStyles}}" target="_blank"><img src="{{src}}" {{pngfix}} {{mouse_events}} width="{{width}}" height="{{height}}" alt="" style="width:{{width}}px !important;background-color:{{bgcolor}};" /></a>\
';
html['bnnr_picture']='\
<div class="begun_adv_image"><a href="{{url}}&area=2" class="snap_noshots" target="_blank"><img src="{{src}}" _big_photo_src="{{big_photo_src}}" _small_photo_src="{{src}}" class="begun_adv_picture" alt="" /></a></div>\
';
html['block_warn']='\
