...
if($title!="" and $meta_d!="" and $meta_k!=""  and $text!="" )
{
   ...
   if($result)
   { 
   echo "<br>Страница успешно отредактированна!<br><br>";
   }
   else {echo "<br>Страница не обновлена! Проверте данные на наличие ошибок!<br><br><a href='edit_pages.php'><< Назад к вводу данных</a><br><br>";}
}

else{
	 echo "<br>Вы должны ввести данные во все поля! Страница не отредактированна!<br><br><a href='edit_pages.php'><< Назад к вводу данных</a><br><br>";
	 }
