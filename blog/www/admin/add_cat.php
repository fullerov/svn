...
if($title!="" and $meta_d!="" and $meta_k!="" and $text!="")
{
   ...
   if($result)
   { 
   echo "<br>Категория успешно добавлена!<br><br>";
   }
   else {echo "<br>Категория не добавлена! Проверте данные на наличие ошибок!<br><br><a href='new_cat.php'><< Назад к вводу данных</a><br><br>";}
}

else{
	 echo "<br>Вы должны ввести данные во все поля! Категория не добавлена!<br><br><a href='new_cat.php'><< Назад к вводу данных</a><br><br>";
	 }
