  ...
  <tr align="center">
    <th height="158" class="back"><table width="1000" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
        ...
        <!--Подключаем левый блок сайта-->
          ...
          <td width="737" align="center" valign="top" class="back"><p class="articles_title">Добавление страницы на сайт</p>
           
            <form id="form1" name="form1" method="post" action="add_page.php">
              <p><hr /></p>
              <p>
              ...
              <p>
                <textarea name="text" id="text_addnp" cols="70" rows="20"></textarea><script language="JavaScript">
  generate_wysiwyg('text_addnp');
</script>
               
                  <br />
                </label>
                <hr  /> <br  />
                  <input type="submit" name="submit" id="submit" value="Добавить страницу" /><input name="reset" type="reset" value="Сброс" />
<br />
                  <br />
                </label>
              </p>
