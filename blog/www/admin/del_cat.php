  ...
  <tr align="center">
    <th height="158" class="back"><table width="1000" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
        ...
        <!--Подключаем левый блок сайта-->
          ...
          <td width="737" align="center" valign="top" class="back"><p class="articles_title">Удаление категорий</p>
          <i><p align="left" style='color:#C8C8C8; margin:30px;'> Выберите категорию для удаления:</p></i>
