  ...
  <tr align="center">
    <th height="158" class="back"><table width="1000" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
        ...
        <!--Подключаем левый блок сайта-->
          ...
          <td width="737" align="center" valign="top" class="back"><p class="articles_title">Удаление ссылок</p>
          <i><p align="left" style='color:#C8C8C8; margin:30px;'> Выберите ссылку для удаления:</p></i>
           <form action="drop_sites.php" method="post">
           <?
		   ...
		   ?>
           <input name="submit" type="submit" value="Удалить ссылку" />
