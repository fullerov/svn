...
$('#add_new').click(function(){
	...
	add+=url+'/addquestion/new"><textarea cols="80" rows="11" id="edqstion" name="question"></textarea><script language="JavaScript">generate_wysiwyg("edqstion");</script><p>Введите ответ на вопрос:</p><input type="text" name="answer" size="90" maxlength="255" value=""><br><p>Введите варианты ответа:</p>';	
