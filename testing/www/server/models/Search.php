...
class Search
{
	...
	public function searchTestsByNames($text)
	{
		...
		$select_user=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM user_test_name WHERE name LIKE $text OR description LIKE $text ORDER BY id DESC");
		$select_org=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM org_test_name WHERE name LIKE $text OR description LIKE $text ORDER BY id DESC");
		$select_school=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM school_test_name WHERE name LIKE $text OR description LIKE $text ORDER BY id DESC");
		$select_univer=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM university_test_name WHERE name LIKE $text OR description LIKE $text ORDER BY id DESC");
	...
	public function searchTestsByDate($date)
	{
		...
		$select_user=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM user_test_name WHERE date LIKE $date ORDER BY id DESC");
		$select_org=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM org_test_name WHERE date LIKE $date ORDER BY id DESC");
		$select_school=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM school_test_name WHERE date LIKE $date ORDER BY id DESC");
	...
	public function getUserTests($theme_id)
	{
		...
		$select=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM user_test_name WHERE theme_id=$theme_id ORDER BY id DESC");
		$select->execute();
	...
	public function getOrgTests($theme_id)
	{
		...
		$select=$db->prepare("SELECT id, name, (SELECT fio FROM users WHERE id=user_id) AS fio, description, (SELECT name FROM countries WHERE id=country_id) AS country_id, (SELECT name FROM cities WHERE id=city_id) AS city_id, time_min, rating, date, quantity, results, count FROM org_test_name WHERE theme_id=$theme_id ORDER BY id DESC");
		$select->execute();
		$select_theme->execute();
