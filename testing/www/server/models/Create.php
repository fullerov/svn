...
class Create
{
	...
	{	//объявление переменных и присвоение им соответствующих значений 
			...
			//формирование строки запроса к БД для вставки теста и информации о нём
			$tmp="INSERT INTO org_test_name (`id`, `user_id`, `country_id`, `city_id`, `theme_id`, `org_id`, `name`, `description`, `time_min`, `rating`, `date`, `quantity`, `results`, `count`) VALUES ('$id', '$user_id', '$country_id', '$city_id', '$test_theme', '$test_org', '$test_name', '$test_description', '$test_min', '0', '$date', '$quantity', '0', '0')";
	...
	static public function addUniverTest($session_test,$questions,$answers)
	{
		//объявление переменных и присвоение им соответствующих значений 
			...
			//формирование строки запроса к БД для вставки теста и информации о нём
			$tmp="INSERT INTO university_test_name (`id`, `user_id`, `country_id`, `city_id`, `university_id`, `faculty_id`, `specialty_id`, `course_id`, `group_id`, `lesson_id`, `name`,`description`, `time_min`, `rating`, `date`, `quantity`, `results`, `count`) VALUES ('$id', '$user_id', '$country_id', '$city_id', '$univer', '$faculty', '$spec', '$course', '$group', '$lesson', '$test_name', '$test_description', '$test_min', '0', '$date', '$quantity', '0', '0')";
	...
	static public function addSchoolTest($session_test,$questions,$answers)
	{
		//объявление переменных и присвоение им соответствующих значений 
			...
			//формирование строки запроса к БД для вставки теста и информации о нём
			$tmp="INSERT INTO school_test_name (`id`, `user_id`, `country_id`, `city_id`, `school_id`, `class_id`, `lesson_id`, `name`, `description`, `time_min`, `rating`, `date`, `quantity`, `results`, `count`) VALUES ('$id', '$user_id', '$country_id', '$city_id', '$school', '$class', '$lesson', '$test_name', '$test_description', '$test_min', '0', '$date', '$quantity', '0', '0')";
