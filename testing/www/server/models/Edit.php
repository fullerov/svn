...
class Edit
{
	...
	public static function getMyUserTests($session)
	{
		...
		$testname="SELECT id, user_id, country_id, city_id, theme_id, name, description, time_min, rating, date, quantity, results, count FROM user_test_name WHERE user_id='$id'";
	...
	public static function getMyOrgTests($session)
	{
		...
		$testname="SELECT id, user_id, country_id, city_id, theme_id, org_id, name, description, time_min, rating, date, quantity, results, count FROM org_test_name WHERE user_id='$id'";;
	...
	public static function getMyUniverTests($session)
	{
		...
		$testname="SELECT id, user_id, country_id, city_id, university_id, faculty_id, specialty_id, course_id, group_id, lesson_id, name, description, time_min, rating, date, quantity, results, count FROM university_test_name WHERE user_id='$id'";
	...
	public static function getMySchoolTests($session)
	{
		...
		$testname="SELECT id, user_id, country_id, city_id, school_id, class_id, lesson_id, name, description, time_min, rating, date, quantity, results, count FROM school_test_name WHERE user_id='$id'";
