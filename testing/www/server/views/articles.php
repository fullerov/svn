...
{ 
	$cnt='<table border="0" width="750">';
	foreach($this->content as $v)
		{
			$cnt.='<tr><td><a href="/articles/get/id/'.$v['id'].'">'.$v['title'].'</a></td></tr>'.
			'<tr><td><img src="'.$v['img'].'"></td></tr><tr><td><p>Добавил: <a href="mailto:'.Registration::getUserEmail($v['user_id']).'">'.Registration::getUserLogin($v['user_id']).'</a> '.$v['date'].' Оценка: '.$v['rating'].' Голосов: '.$v['votes'].'</p></td></tr>
			<tr><td id="list_txt">'.substr($v['text'],0,350).'...</td></tr>';
		}
