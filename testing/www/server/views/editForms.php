...
function getArticles($articles)
{
	...
	if(is_array($articles))
	{
		...
		foreach($articles as $article)
		{
			...
			<textarea name="text" cols="80" id="edterticle" rows="45">'.$article['text'].'</textarea><script language="JavaScript">
  generate_wysiwyg("edterticle");
</script><br>
...
function getSerachForms($usertests, $orgtests)
{
	...
	<label for="date">Поиск тестов по дате:</label><br>
	<input type="date" name="date" size="80" maxlength="255" min="3">
