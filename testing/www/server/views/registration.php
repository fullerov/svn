...
<tr><td ><input type="text" maxlength="255" size="50" name="login" /></td></tr>
...
<tr><td ><input onblur="emailChecking()" type="text" maxlength="255" size="50" name="email" /></td></tr>
<tr><td ><label for="tel">Введите Ваш телефон:</label></td></tr>
<tr><td ><input type="text" maxlength="255" size="50" name="tel" /></td></tr>
...
<tr><td ><input type="text" maxlength="255" size="50" name="birthdate" /></td></tr>
...
<tr><td align="center"><label for="captcha">Введите буквы с картинки:</label><br /><img src="server/views/captcha.php" /></td></tr>
